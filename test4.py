...
def main_structure(inp):
	with tf.variable_scope('mainModel'):
		...
		#mod.dwconvLayer(5,8,activation=M.PARAM_LRELU)
		#mod.maxpoolLayer(2)
		mod.dwconvLayer(3,16,activation=M.PARAM_LRELU)
		#mod.maxpoolLayer(2)
		...
		#mod.incep(4,32,4,32,2,activation=M.PARAM_RELU, batch_norm= True)
		#mod.incep(8,8,8,8,8,activation=M.PARAM_LRELU, batch_norm= True)
		#mod.convLayer(3,256,activation=M.PARAM_LRELU, batch_norm= True)#8_8x8
		#mod.convLayer(3,256,activation=M.PARAM_LRELU,batch_norm = True)#8_8x8
		mod.flatten()
		mod.fcLayer(120)
